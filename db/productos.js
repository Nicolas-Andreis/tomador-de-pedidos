...
const tiposDeProductos = {
    pizzas: productosPizzas,
    promos: productosPromos,
};
...
agregarTarjetas(containerPromos, productosPromos, "Promos");
agregarTarjetas(containerPizzas, productosPizzas, "Pizzas");
agregarTarjetas(containerMediasPizzas, productosMediasPizzas, "MediasPizzas");
agregarTarjetas(containerCombos, productosCombos, "Combos");
agregarTarjetas(containerBurguersSolas, productosBurguerSola, "BurguerSola");
agregarTarjetas(containerEmpanadas, productosEmpanadas, "Empanadas");
agregarTarjetas(containerCalzones, productosCalzones, "Calzones");
agregarTarjetas(containerPapas, productosPapas, "Papas");
agregarTarjetas(containerEnsaladas, productosEnsaladas, "Ensaladas");
agregarTarjetas(containerPostres, productosPostres, "Postres");
agregarTarjetas(containerBebidas, productosBebidas, "Bebidas");
agregarTarjetas(containerCervezas, productosCervezas, "Cervezas");
agregarTarjetas(containerHelados, productosHelados, "Helados");
...
function agregarAlcarrito(e) { //e = evento
    ...
    switch (container) {
        case "Pizzas":
            productoAgregado = productosPizzas.find(producto => producto.nombre === idBoton);
            break;
        case "Promos":
            productoAgregado = productosPromos.find(producto => producto.nombre === idBoton);
            break;
        case "MediasPizzas":
            productoAgregado = productosMediasPizzas.find(producto => producto.nombre === idBoton);
            break;
        case "Combos":
            productoAgregado = productosCombos.find(producto => producto.nombre === idBoton);
            break;
        case "BurguerSola":
            productoAgregado = productosBurguerSola.find(producto => producto.nombre === idBoton);
            break;
        case "Empanadas":
            productoAgregado = productosEmpanadas.find(producto => producto.nombre === idBoton);
            break;
        case "Calzones":
            productoAgregado = productosCalzones.find(producto => producto.nombre === idBoton);
            break;
        case "Papas":
            productoAgregado = productosPapas.find(producto => producto.nombre === idBoton);
            break;
        case "Ensaladas":
            productoAgregado = productosEnsaladas.find(producto => producto.nombre === idBoton);
            break;
        case "Postres":
            productoAgregado = productosPostres.find(producto => producto.nombre === idBoton);
            break;
        case "Bebidas":
            productoAgregado = productosBebidas.find(producto => producto.nombre === idBoton);
            break;
        case "Cervezas":
            productoAgregado = productosCervezas.find(producto => producto.nombre === idBoton);
            break;
        case "Helados":
            productoAgregado = productosHelados.find(producto => producto.nombre === idBoton);
            break;

        // Agrega más casos para otros tipos de productos si es necesario
        default:
    ...
    if (productosEnCarrito.some(producto => producto.nombre === idBoton)) {
        ...
        productoAgregado.cantidad = 1; //creamos esto en el objeto para que cuenten con la propiedad 1
        productosEnCarrito.push(productoAgregado);
    };//necesitamos saber si esta ne el array, devuelve true o false

    actualizarNumerito(); //se ejecuuta cada vez que agregamos elementos
